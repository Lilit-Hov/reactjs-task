    ...
    render() {
        return(
                <div className="two-images-grid">
                    <div style={{backgroundImage:`url(${layoutImg})`}} className="poster mb-3" />
                    <div className="d-flex">
                        ...
                        <div>
                            ...
                            <p className="date mb-2"><i className="icon-date" /> <span>20.10.2019</span></p>
                            <p className="mb-2">Lorem Ipsum is simply dummy text of the printing and typesetting
                                industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s,
                                when an unknown printer took a galley of type and scrambled it to make a type specimen book.
                            </p>
                            <div style={{backgroundImage:`url(${layoutImg})`}} className="poster mb-2" />
